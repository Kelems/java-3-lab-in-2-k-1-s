...
public class Book {
    ...
    static {
        ...
        books.add(new Book(6, "Гарри Поттер и философский камень", "Джоан Роулинг", "Стеллаж 6, Полка 7", false, false));
        books.add(new Book(7, "Грозовой перевал", "Эмили Бронте", "Стеллаж 7, Полка 8", true, false));
        books.add(new Book(8, "Гордость и предубеждение", "Джейн Остин", "Стеллаж 8, Полка 9", false, true));
        books.add(new Book(9, "Маленький принц", "Антуан де Сент-Экзюпери", "Стеллаж 9, Полка 10", false, false));
        books.add(new Book(10, "Три мушкетера", "Александр Дюма", "Стеллаж 10, Полка 11", true, false));
    }
